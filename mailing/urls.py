...
urlpatterns = [
    ...
    path(
        ...
        views.MailingSendNowView.as_view(),
        name="mailing_send_now",
    ),
    # Панель менеджера
    path("manager/users/", views.UserListView.as_view(), name="manager_user_list"),
    path(
        "manager/users/<int:pk>/toggle/",
        views.UserToggleActiveView.as_view(),
        name="manager_user_toggle",
    ),
    path(
        "manager/mailings/",
        views.AllMailingListView.as_view(),
        name="manager_all_mailings",
    ),
    path(
        "manager/mailings/<int:pk>/disable/",
        views.MailingDisableView.as_view(),
        name="manager_mailing_disable",
    ),
]
